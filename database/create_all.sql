...
alter table t_cash_application add constraint FK_pk_cash_application_user foreign key (user_id)
   references t_user (id) on delete restrict on update restrict;

alter table t_commodity add constraint FK_pk_commodity_and_store foreign key (store_id)
   references t_store (id) on delete restrict on update restrict;

alter table t_general_time_range add constraint FK_fk_general_time_range_and_commodity foreign key (commodity_id)
   references t_commodity (id) on delete restrict on update restrict;

alter table t_general_time_slot add constraint FK_Reference_5 foreign key (time_range_id)
   references t_general_time_range (id) on delete restrict on update restrict;

alter table t_order add constraint FK_pk_order_commodity foreign key (commodity_id)
   references t_commodity (id) on delete restrict on update restrict;

alter table t_order add constraint FK_pk_order_store foreign key (shop_id)
   references t_store (id) on delete restrict on update restrict;

alter table t_order add constraint FK_pk_order_user foreign key (user_id)
   references t_user (id) on delete restrict on update restrict;

alter table t_special_time_range add constraint FK_fk_special_time_range_and_commodity foreign key (commodity_id)
   references t_commodity (id) on delete restrict on update restrict;

alter table t_special_time_slot add constraint FK_Reference_4 foreign key (time_range_id)
   references t_special_time_range (id) on delete restrict on update restrict;

alter table t_user add constraint FK_Reference_10 foreign key (leader_id)
   references t_user (id) on delete restrict on update restrict;
